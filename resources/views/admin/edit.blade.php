        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0">Update Author's Details</h3>
                </div>
            </div>
        </div> <!-- Row end  -->
        ...
        <div class="row align-item-center">
            <div class="col-md-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="/{{ $owner->id }}/edit" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    <label for="firstname" class="form-label">Name</label>
                                    <input type="text" name="name" value="{{ $owner->name }}" class="form-control" id="firstname" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="lastname" class="form-label">Email Address</label>
                                    <input type="text" name="email" value="{{ $owner->email }}" class="form-control" id="lastname" required>
                                </div>
                                <div class="col-md-12">
                                    <label for="addnote" class="form-label">Biography</label>
                                    <textarea  class="form-control" name="biography" id="addnote" rows="3">{{ $owner->biography }}</textarea> 
                                </div>
                                
                                <div class="col-md-6">
                                    <label  class="form-label">Phone Number</label>
                                    <input type="text" name="phone"value="{{ $owner->phone }}" class="form-control" id="phonenumber" required>
                                </div>
                                {{-- <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" value="{{ asset('images/' . $owner->image) }}" name="image" type="file" id="formFileMultiple">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea  class="form-control" name="description" id="addnote" rows="3">{{ $owner->description }}</textarea> 
                                </div>
