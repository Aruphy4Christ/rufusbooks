                            ...
                            {{ __('E-Mail Address') }}:
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-label">
                                        ...
                                        @enderror
                                        <input type="email" class="form-control form-control-lg"  @error('email') border-red-500 @enderror name="email" value="{{ old('email') }}" required autocomplete="email" autofocusclass="form-control form-control-lg" placeholder="name@example.com">
                                    </div>
                                </div>
                                </div>
                    {{-- </div> --}}
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        required class="form-control form-control-lg" placeholder="***************">
                                    </div>
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button type="submit"
                                     class="btn btn-lg btn-block btn-light lift text-uppercase" alt="signin">SIGN IN
                                </button>
                                </div>
